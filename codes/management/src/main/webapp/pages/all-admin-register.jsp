...
<body class="hold-transition register-page register-my-body">
    ...
    <div class="register-box">
        <div class="register-logo">
            ...
            <a href="admin.jsp?index=0" style="color: ghostwhite;"><b>厦门大学校园二手</b><br />后台管理注册</a>
        ...
        <div class="register-box-body">
            ...
            <form action="/rigisterServlet" method="post" onsubmit="return formCheck()">
