  ...
  <div class="registerDivClass">
    <el-card shadow="always" style="top:50px;margin: 0 auto;width: 29%;min-height: 650px;position: relative;">
      <div style="text-align:center;margin-top: 30px;">
        <img src="../../assets/xmu-logo.png" alt="logoImg" style="max-width: 90px;">
      ...
      <el-row type="flex" class="row-bg" justify="center" style="top: 10px;">
        <el-col :span="24">
          <h6 style="text-align: center;color: #757575;">厦门大学二手交易系统 版权所有</h6>
          <h6 style="text-align: center;color: #757575;">Copyright © 2024</h6>
        </el-col>
      </el-row>
    </el-card>
