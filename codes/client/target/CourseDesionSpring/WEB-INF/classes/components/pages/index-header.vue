    ...
    <nav class="navbar index-header-bar">
      <el-row>
        <el-col :span="3" :offset="2">
          <img src="https://www.xmu.edu.cn/images/logo.png" alt="logoImg" style="max-width:150px;">
<!--          <span>厦门大学校园二手交易平台</span>-->
        </el-col>
...
<!--                  <a href="#" class="my-dropdown-menu-li-1">登录</a>-->
                  <a class="my-dropdown-menu-li-1" @click="checkLogin1">  登  录  </a>
                </li>
                <li>
<!--                  <a href="#" class="my-dropdown-menu-li-1">注册</a>-->
                  <a class="my-dropdown-menu-li-1" @click="checkLogin2">  注  册  </a>
                </li>
              </ul>
            </el-col>
            <el-col :span="3" :offset="1" class="index-header-bar-span">
...
.index-header-bar{
  border-radius: 0;
  line-height: 60px;
  background-color: rgba(100, 68, 136, 1);
  position:fixed;
  width: 100%;
  z-index: 999;
}
